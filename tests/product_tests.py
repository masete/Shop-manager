...
class TestEndpoints(unittest.TestCase):
    ...
    def test_post_a_product_name_is_passed_space(self):
        with self.app.test_client() as client:
            ...
            self.assertIn('Product field can not have space', feedbackJson['message'])
    ...
    def test_post_a_product_is_passed_empty_field(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Product field can not be empty', feedbackJson['message'])
    ...
    def test_post_a_product_price_is_passed_empty_field(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Product price field cant be empty', feedbackJson['message']) 
    ...
    def test_post_a_product_price_is_passed_empty_string(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Product price field cant be passed empty string', feedbackJson['message'])            
    ...
    def test_post_a_product_price_is_int(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Product price field can not be a string', feedbackJson['message'])                                                    
    ...
    def test_post_a_product_name_is_string(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Product name field can not be an int', feedbackJson['message'])  
    ...
    def test_product(self):
        with self.app.test_client() as client:
            ...
            feedbackJson = json.loads(feedback.data.decode())
            self.assertIn("a product now exists", feedbackJson["message"])
            self.assertTrue(feedback.content_type, 'application/json')
    ...
    def test_post_a_sale_quantity_is_passed_space(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())
            self.assertIn('Sale field can not have space', feedbackJson['message'])
            self.assertTrue(feedback.content_type, 'application/json')        
    ...
    def test_post_a_sale_quantity_is_passed_empty_string(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())
            self.assertIn('Sale field can not be passed empty string', feedbackJson['message'])
            self.assertTrue(feedback.content_type, 'application/json')    
    ...
    def test_post_a_sale_price_is_int(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('sale price field can not be a string', feedbackJson['message']) 
    ...
    def test_post_a_sale_price_is_passed_empty_field(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Sales price field cant be empty', feedbackJson['message'])  
    ...
    def test_post_a_sale_price_is_passed_empty_string(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('Sales price field cant be passed an empty string', feedbackJson['message']) 
    ...
    def test_post_a_sale_quantity_is_string(self):
        with self.app.test_client() as client:
            ...
            self.assertEqual(feedback.status_code, 400)
            feedbackJson = json.loads(feedback.data.decode())                                                     
            self.assertIn('sale quantity field can not be an int', feedbackJson['message'])
